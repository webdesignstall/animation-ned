            ...
            <section className="scroll-section-outer">    
                <div ref={triggerRef}>
                    ...
                    <div className="scroll-section">
                      <div class="flex flex-col items-center justify-around h-[100vh] w-[1263px]">
                        <p 
                        className=""
                        style={{
                        ...
                        <div>
                          ...
                          Als Architect weten wij uw droom te realiseren. Met inzet van onze professie en ervaring kunnen we tot in detail op uw wensen inspelen. Van luxe villa’s tot project of utiliteitsbouw. Van idee tot werkelijkheid. Dit doen wij al meer dan 35 jaar met plezier.
                          </p>
                      ...
                      <div className="flex gap-5">
                       ...
                       <div class="ml-[200px]">
                        ...
                        <div className="mb-[50px]">
                          <p className={`${rubik.className} uppercase mb-4`} style={{
                          ...
                          <p className={`${rubik.className}`} style={{
                        ...
                        <div className="mb-[50px]">
                          ...
                          <p className={`${rubik.className}`} style={{
                            ...
                            textAlign: 'left',
                             ...
                             Hendrik Wachterstraat 13 <br/> 3065 LD Rotterdam <br/> Nederland
                          </p>
