    ...
    useGSAP(()=> {
        ...
        const scrollTween = gsap.to(sections, {
            ...
            scrollTrigger: {
                ...
                end: ()=> "+=" + document.querySelector('.scroll-section-inner').offsetWidth

            }
        })

        let categoriesImage = gsap.utils.toArray('.category-image');
        gsap.fromTo('.category-image1',  {
            scale: 1.5,
        }, {
            scale: 1,
            duration: 2,
            scrollTrigger: {
                trigger: '.category-image1',
            ...
            <section className="scroll-section-outer">
                <div>
                    <div className="scroll-section-inner">
                        ...
                        <div className="scroll-section">
                            <div className="flex gap-5 category-wrap">
